  ...
  const faqData = [
    {
      ...
      questions: [
        {
          q: "What types of products does Elite Print Care offer?",
    ...
    },
    {
      ...
      questions: [
        {
          q: "Is Elite Print Care affiliated with any printer brands?",
          a: "No. Elite Print Care is an independent online retailer. All product names, logos, and trademarks belong to their respective owners and are used solely for identification and compatibility purposes."
        }
      ]
    },
    {
