...
const PrinterBuyingGuide = () => (
  <div className="max-w-4xl mx-auto px-4 py-10 space-y-8 bg-white rounded-3xl shadow-lg">
    ...
    <h2 className="text-xl font-bold text-blue-800 mb-2">Elite Print Care</h2>
    <section className="space-y-2">
      <h3 className="text-lg font-bold text-blue-700">Overview</h3>
      <p className="text-black">Selecting the appropriate printer requires evaluating several technical and operational factors, including print volume, cost-per-page, connectivity requirements, and long-term consumable costs.<br />This Buying Guide is provided by Elite Print Care to help customers make informed purchasing decisions based on individual usage needs.<br />The information presented on this page is for general informational purposes only and should not be interpreted as professional technical advice.</p>
    </section>
    <section className="space-y-2">
    ...
    <section className="space-y-2">
      ...
      <p className="text-black">Elite Print Care recommends verifying system compatibility prior to purchase.</p>
    </section>
    <section className="space-y-2">
    ...
    <section className="space-y-2">
      ...
      <p className="text-black">This Buying Guide is provided for general informational purposes only.<br />Elite Print Care does not guarantee that any specific printer model will meet every individual requirement. Customers are responsible for evaluating product specifications and ensuring suitability for their intended use.</p>
    </section>
    <section className="space-y-2">
