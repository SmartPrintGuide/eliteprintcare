  ...
  <section className="w-full bg-gray-50 min-h-screen py-16">
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-gray-600 text-base sm:text-lg leading-relaxed">This Disclaimer applies to your use of the website located at:<br/><CompanyWebsiteLink className="text-blue-700" /> ("Website")</p>
      ...
      <div className="space-y-10">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600 leading-relaxed">The content provided on this Website is for general informational and commercial purposes only.<br/>While we strive to provide accurate and up-to-date information, Elite Print Care makes no representations or warranties, express or implied, regarding:</p>
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600 leading-relaxed">Product descriptions, specifications, compatibility details, and images are provided based on information available from suppliers and manufacturers.<br/>Elite Print Care does not guarantee that:</p>
          <ul className="list-disc pl-6 text-gray-600">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600 leading-relaxed">Incorrect purchases resulting from failure to confirm compatibility are not the responsibility of Elite Print Care.<br/>We recommend confirming the exact printer model and cartridge code prior to ordering.</p>
        </div>
        <div className="space-y-4">
          <h2 className="text-2xl font-semibold text-blue-700">5. Pricing & Typographical Errors</h2>
          <p className="text-gray-600 leading-relaxed">Although we strive for accuracy, pricing or typographical errors may occur.<br/>Elite Print Care reserves the right to:</p>
          <ul className="list-disc pl-6 text-gray-600">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600 leading-relaxed">Products sold on this Website may be covered by manufacturer warranties where applicable.<br/>Elite Print Care does not independently provide warranties beyond those offered by the manufacturer unless explicitly stated.<br/>To the fullest extent permitted by law, products are provided on an "AS IS" and "AS AVAILABLE" basis.<br/>We disclaim all implied warranties, including but not limited to:</p>
          <ul className="list-disc pl-6 text-gray-600">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600 leading-relaxed">The Website may contain links to third-party websites for convenience.<br/>Elite Print Care:</p>
          <ul className="list-disc pl-6 text-gray-600">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600 leading-relaxed">To the fullest extent permitted by applicable law, Elite Print Care shall not be liable for:</p>
          <ul className="list-disc pl-6 text-gray-600">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600 leading-relaxed">Elite Print Care reserves the right to modify this Disclaimer at any time.<br/>Changes become effective upon posting on this Website.<br/>Continued use of the Website constitutes acceptance of updated terms.</p>
        </div>
        <div className="space-y-4">
