  ...
  <section className="w-full bg-gray-50 min-h-screen py-16">
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-gray-600 text-base sm:text-lg leading-relaxed">This Shipping Policy explains how Elite Print Care ("Company," "we," "our," or "us") processes, ships, and delivers orders placed through: <CompanyWebsiteLink className="text-blue-700" /> ("Website").<br/>By placing an order, you agree to the terms described in this Policy.</p>
      </div>
      <div className="space-y-10">
        <div className="space-y-4">
          ...
          <div className="text-gray-600 leading-relaxed">
            ...
            <p className="mt-2">
              ...
              Elite Print Care operates exclusively as an online retail platform.
            </p>
          </div>
        </div>
        <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 text-gray-600">
            <li>Elite Print Care partners with established national shipping carriers.</li>
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 text-gray-600">
            ...
            <li>Elite Print Care is not liable for delays caused by third-party carriers.</li>
          </ul>
        </div>
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 text-gray-600">
            ...
            <li>After transfer to the carrier:
              <ul className="list-disc pl-6">
                ...
                <li>Elite Print Care is not responsible for delays, loss, or damage occurring during transit, except where required by law.</li>
              </ul>
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 text-gray-600">
            ...
            <li>Elite Print Care is not liable for lost or stolen packages after confirmed delivery.</li>
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 text-gray-600">
            <li>Elite Print Care shall not be liable for failure or delay in shipment due to circumstances beyond our reasonable control, including but not limited to:</li>
            <ul className="list-disc pl-10 text-gray-600">
        ...
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 text-gray-600">
            <li>At this time, Elite Print Care primarily ships within the United States unless otherwise stated at checkout.</li>
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600 leading-relaxed">Elite Print Care operates as an independent online retailer and is not affiliated with printer manufacturers unless explicitly stated. All trademarks remain the property of their respective owners.</p>
        </div>
        <div className="space-y-4">
