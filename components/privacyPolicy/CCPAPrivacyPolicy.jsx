        ...
        <div className="space-y-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 leading-relaxed">
              Elite Print Care is committed to maintaining high standards of data privacy, transparency, and security. We strictly limit the collection and use of your personal information to essential business functions such as:
            </p>
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 leading-relaxed">
              Important Statement: Elite Print Care does NOT sell or share your personal information as defined under CCPA/CPRA. We do not use cross-site tracking, profiling, third-party marketing cookies, or advertising pixels.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-1">
              <li>✓ Elite Print Care does NOT sell personal information.</li>
              <li>✓ Elite Print Care does NOT share personal information for advertising.</li>
              <li>✓ Elite Print Care has not sold or shared personal information in the past 12 months.</li>
              <li>✓ Elite Print Care does not knowingly collect or sell the information of minors under 16.</li>
            </ul>
          </div>
