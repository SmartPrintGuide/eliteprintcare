...
export default function HelpCenter() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <h1 className="text-3xl md:text-4xl font-bold text-blue-900 mb-4 text-center">Elite Print Care Help Center</h1>
      <p className="text-base text-black mb-8 text-center">
        Welcome to the Elite Print Care Help Center.<br />
      ...
      <div className="text-xs text-gray-400 mt-8 text-center">
        <b>Independent Retailer Disclosure:</b> Elite Print Care operates as an independent online retailer. We are not affiliated with, endorsed by, or authorized by any printer manufacturer unless explicitly stated. All brand names and trademarks remain the property of their respective owners.
      </div>
    </div>
  );
}
