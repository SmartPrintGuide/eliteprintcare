    ...
    <div className="max-w-5xl mx-auto px-4 py-12 min-h-screen rounded-3xl shadow-[0_10px_40px_0_rgba(30,64,175,0.10)] bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
        ...
        <div className="bg-blue-50 rounded-3xl shadow border border-blue-100 p-8 space-y-4">
          ...
          <p className="text-black">Elite Print Care operates as an independent online retailer and is not affiliated with, endorsed by, or authorized by any printer manufacturer unless explicitly stated. Brand references are used solely for identification and compatibility purposes.</p>
        </div>
        <div className="bg-blue-50 rounded-3xl shadow border border-blue-100 p-8 space-y-4">
          <h2 className="text-lg font-bold text-blue-900 uppercase tracking-tight mb-2">Mailing Address for Correspondence</h2>
          <p className="text-black">Elite Print Care<br />7181 Beacon Dr 15<br />Reno, NV 89506<br />United States</p>
        </div>
        {/* Website */}
        <div className="bg-white/80 rounded-3xl shadow-2xl border border-blue-200 p-8 space-y-4 backdrop-blur-md transition-all hover:scale-[1.02]">
          ...
          <p className="text-blue-900 font-medium">
            <span className="text-blue-600 underline font-bold">www.eliteprintcare.com</span><br />Browse our selection of printers, ink, toner, and printing essentials anytime.
          </p>
        </div>
        {/* How We Can Help */}
        <div className="bg-white/80 rounded-3xl shadow-2xl border border-blue-200 p-8 space-y-4 backdrop-blur-md transition-all hover:scale-[1.02]">
