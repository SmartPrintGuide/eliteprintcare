...
const AboutContent = () => (
  <section className="w-full bg-gradient-to-b from-blue-50 to-white py-0">
    ...
    <div className="w-full bg-blue-900 py-12 px-4 sm:px-8 flex flex-col items-center text-center">
      <h1 className="text-4xl sm:text-5xl font-extrabold text-white mb-4 drop-shadow-lg">About Elite Print Care</h1>
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-8 py-12 grid gap-12">
      ...
      <section className="bg-blue-50 rounded-xl shadow p-8">
        ...
        <p className="text-black">
          To contact us:<br/>
          <a href="mailto:support@eliteprintcare.com" className="text-blue-600 underline">support@eliteprintcare.com</a><br/>
      ...
      <section className="bg-blue-50 rounded-xl shadow p-8">
        ...
        <p className="text-black">
          <span className="font-bold text-blue-500">Elite Print Care</span><br/>
